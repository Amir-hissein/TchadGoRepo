...
struct MidleView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationDestination(isPresented: $showLiked) {
                LikedImagesView(likedPlaces: $likedPlaces, totalCount: imageCount)
            }
    ...
    private func imageCard(index: Int) -> some View {
    ...
    private func likeButton(index: Int) -> some View {
        Button {
            ...
            Image(systemName: likedPlaces[index] == true ? "heart.fill" : "heart")
                .foregroundColor(likedPlaces[index] == true ? .red : .white)
                .padding(8)
    ...
    private var likedSectionButton: some View {
        Button(action: { showLiked = true }) {
            HStack {
